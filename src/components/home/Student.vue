        ...
        <section class="student">
            <div class="student-content">
                <div class="student-info">
                    ...
                    <button class="student-btn">Регистрация</button>
                </div>
                <img src="../../assets/image/student/image.png" alt="student-image" class="student-img">
                <button class="student-another_btn">Регистрация</button>
            </div>
        </section>
    </div>
</template>
...
.student {
    ...
    &-another_btn {
        display: none;
        background: linear-gradient(102.75deg, #3822C2 8.02%, #8D75F2 98.24%);
        border-radius: 8.45714px;
        font-weight: 600;
        font-size: 15.2229px;
        letter-spacing: 0.05em;
