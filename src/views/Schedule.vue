                ...
                <div class="schedule-wrapper">
                    <table>
                        ...
                        <tbody>
                            ...
                            <!-- <tr>
                                <td v-for="item in mvp[0]['Вторник']" :key="item.id">
                                    <div class="schedule-block">
                                        <p class="schedule-name">{{ item.discipline.urok.title  }}</p>
                                        <span class="schedule-time">
                                            <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                            ...
                            <!-- <tr>
                                <td v-for="item in mvp[0]['Среда']" :key="item.id">
                                    <div class="schedule-block">
                                        <p class="schedule-name">{{ item.discipline.urok.title  }}</p>
                                        <span class="schedule-time">
                                            <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                            ...
                            <tr>
                                <td v-for="item in mvp[0]['Четверг']" :key="item.id">
                                    <div class="schedule-block">
                                        <p class="schedule-name">{{ item.discipline.urok.title  }}</p>
                                        <span class="schedule-time">
                                            <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                            ...
                            <tr>
                                <td v-for="item in mvp[0]['Пятница']" :key="item.id">
                                    <div class="schedule-block">
                                        <p class="schedule-name">{{ item.discipline.urok.title  }}</p>
                                        <span class="schedule-time">
                                            <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                            ...
                            <tr>
                                <td v-for="item in mvp[0]['Суббота']" :key="item.id">
                                    <div class="schedule-block">
                                        <p class="schedule-name">{{ item.discipline.urok.title  }}</p>
                                        <span class="schedule-time">
                                            <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
